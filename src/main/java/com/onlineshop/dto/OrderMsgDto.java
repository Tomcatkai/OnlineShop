...
public class OrderMsgDto {
    ...
    public OrderMsgDto(String orderId, Date orderTime, BigDecimal orderTotal, Integer orderStatus, String addressReceiver, String addressReceiverPhone, String addressDetail, String addressProvince, String addressCity, String addressArea) {
